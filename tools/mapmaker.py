...
class MapMakerApp:
    def __init__(self, master):
        ...
        self.goal_range_entry.insert(0, "0.05") 
        ...
        self.distance_unit_entry.insert(0, "0.02") 
        ...
        self.map_resolution_entry.insert(0, "50") 
    ...
    def coords_to_normalized(self, x, y):
        ...
        norm_y = max(0.0, min(1.0, 1.0 - (y / self.canvas_height))) 
    ...
    def normalized_to_coords(self, norm_x, norm_y):
        ...
        y = (1.0 - norm_y) * self.canvas_height 
        return x, y
    ...
    def on_press(self, event):
        ...
        if mode == "obstacle":
            ...
            if self.start_point:
                self.canvas.delete(self.start_point) 
            ...
            if self.goal_point:
                self.canvas.delete(self.goal_point) 
    ...
    def on_release(self, event):
        ...
        if mode == "obstacle" and self.temp_rect and self.start_coords:
            ...
            obstacle_data = ((norm_x1, norm_y2), (norm_x2, norm_y1)) 
    ...
    def redraw_canvas(self):
        ...
        for obs in self.obstacles:
            ...
            cx1, cy1 = self.normalized_to_coords(norm_x1, norm_y1) 
            cx2, cy2 = self.normalized_to_coords(norm_x2, norm_y2) 
